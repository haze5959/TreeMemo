...
//import Combine
//
//class TreeMemoViewModel: ObservableObject {
//    let didChange = PassthroughSubject<Void, Never>()   //값이 들어오면 해당 뷰모델 바인딩 된 뷰 업데이트
//
//    /**
//     해당 Key의 트리데이터 리턴
//     */
...
//            let rootData = [TreeModel(title: "New", key:RootKey, index: 0)]
